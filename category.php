            ...
            <div class="col-md-8">
                ...
                ?>
                  ...
                  <?php
                    ...
                    $sql="SELECT  post.title, post.description, post.post_date,category.category_name, user.username ,post.post_img, post.post_date, post.post_id FROM post 
                    LEFT JOIN category ON post.category=category.category_id 
                    LEFT JOIN user ON post.author=user.user_id WHERE category.category_id={$cat_id} LIMIT {$offset},{$limit}";
                  ...
                  ?>
                                ...
                                <div class="inner-content clearfix">
                                    ...
                                    <div class="post-information">
                                        <span>
                                            ...
                                            <a href="category.php?cat_id=<?php echo $cat_id; ?>"><?php echo $row['category_name']; ?></a>
                                        </span>
                                        <span>
                    ...
                    LEFT JOIN category ON post.category=category.category_id 
                    LEFT JOIN user ON post.author=user.user_id WHERE category.category_id={$cat_id}";
